...
# | Customer Message | Category | Reason |
CATEGORY: | ACCOUNT SUPPORT | BILLING | DELIVERY | RETURNS |

1. forgot my password and can't log into my account. | ACCOUNT SUPPORT | The customer is requesting assistance with their account.|

2. I was charged twice for my subscription this month. | BILLING | The customer is reporting a billing issue involving a subscription charge.|

3. My order was supposed to arrive yesterday, but I haven't received it. | DELIVERY | The customer is reporting on a delivery issue because the order has not arrived.|
